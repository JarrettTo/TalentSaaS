...
export const RatesFrozenRows = (props: RatesRow) => {
  const {
    ratesPlacement,
    placementsLastLogs,
    disabled,
  ...
  return (
    <div className="grid grid-cols-[auto_1fr] items-center mt-3">
      
      <div className="flex overflow-auto">
      <div className="grid grid-cols-[repeat(10,_minmax(0,_1fr))]">
      
      <div className={clsx(cellClasses, "w-44 flex items-center gap-2 items-center flex") }style={{height:44}}>
      ...
      <div className={clsx(cellClasses, "w-44 overflow-hidden text-ellipsis items-center flex")} style={{height:44}}>
        <p>
          $
